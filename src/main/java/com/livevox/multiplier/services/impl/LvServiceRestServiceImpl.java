...
import com.livevox.multiplier.services.LvServiceRestService;
...
public class LvServiceRestServiceImpl extends LvSessionRestServiceImpl
    ...
    public List<Skill> getSkills(Integer callCenterId, Integer clientId, String apiSessionId, Integer count,
        ...
        RestServiceAbstract.log.debug("Start getSkills() for callCenter " + callCenterId + " clientId " + clientId);
        ...
        try {
            ...
            RestServiceAbstract.log.error("List services failed for client " + clientId + " call center " + callCenterId, e);
            throw new WebServiceException("List services failed for client" + clientId + "call center " + callCenterId);
        }

        if (resp == null) {
            RestServiceAbstract.log.error("Unable to retrieve services. The response was invalid. ");
        ...
        RestServiceAbstract.log.debug("End getSkills() ");
    ...
    public SkillRelatedDetails getSkillRelatedDetails(Integer skillId, Integer clientId, String apiSessionId,
        ...
        RestServiceAbstract.log.debug("Start getSkillRelatedDetails() ");
        ...
        try {
            ...
            RestServiceAbstract.log.error("Get skill related details failed. ", e);
            throw new WebServiceException("Get skill related details failed. ");
        }

        if (resp == null) {
            RestServiceAbstract.log.error("Get skill related details failed. The response was invalid. ");
            throw new WebServiceException("Get skill related details failed. The response was invalid ");
        }
        RestServiceAbstract.log.debug("End getSkillRelatedDetails() ");
        return resp;
    }
    ...
    public SkillDetails getSkillGeneralProperties(Integer skillId, Integer clientId, String apiSessionId,
                                                  String apiVersion) throws WebServiceException {
        RestServiceAbstract.log.debug("Start getSkillGeneralProperties() ");
        if (clientId == null || skillId == null) {
            throw new WebServiceException(" Required value was null ");
        }
        ...
        try {
            ...
            RestServiceAbstract.log.error("Get skill general properties failed. ", e);
            throw new WebServiceException("Get skill general properties failed. ");
        }

        if (resp == null) {
            RestServiceAbstract.log.error("Get skill general properties failed. The response was invalid. ");
            throw new WebServiceException("Get skill general properties failed. The response was invalid ");
        }
        RestServiceAbstract.log.debug("End getSkillGeneralProperties() ");
        return resp;
    }
    ...
    public SkillPhoneSettings getSkillPhoneSettings(Integer skillId, Integer clientId, String apiSessionId,
                                                    String apiVersion) throws WebServiceException {
        RestServiceAbstract.log.debug("Start getSkillPhoneSettings() ");
        if (clientId == null || skillId == null) {
            throw new WebServiceException(" Required value was null ");
        }
        ...
        try {
            ...
            RestServiceAbstract.log.error("Get skill phone settings failed.", e);
            throw new WebServiceException("Get skill phone settings failed.");
        }

        if (resp == null) {
            RestServiceAbstract.log.error("Unable to retrieve skill phone settings. The response was invalid. ");
            throw new WebServiceException("Get skill phone settings failed. The response was invalid ");
        }
        RestServiceAbstract.log.debug("End getSkillPhoneSettings() ");
        return resp;
    }
    ...
    public SkillSettings getSkillSettings(Integer skillId, Integer clientId, String apiSessionId, String apiVersion)
        ...
        try {
            ...
            RestServiceAbstract.log.error("Get skill settings failed.", e);
            throw new WebServiceException("Get skill settings failed.");
        }

        if (resp == null) {
            RestServiceAbstract.log.error("Unable to retrieve skill settings. The response was invalid. ");
