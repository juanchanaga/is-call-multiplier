...
import com.livevox.multiplier.domain.exceptions.AuthenticationException;
...
import com.livevox.multiplier.services.LvSessionRestService;
import com.livevox.multiplier.services.RestServiceLvAbstract;
...
public class LvSessionRestServiceImpl extends RestServiceLvAbstract implements LvSessionRestService {
    ...
    @Autowired
    public LvSessionRestServiceImpl(@Qualifier("atgConfigServiceImpl") AtgConfigService atgConfigService) {
        super(atgConfigService);
    }

    @Autowired
    public LvSessionRestServiceImpl(@Qualifier("atgConfigServiceImpl") AtgConfigService atgConfigService, SignInService signInService) {
