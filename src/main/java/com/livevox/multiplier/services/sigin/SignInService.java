...
package com.livevox.multiplier.services.sigin;

import com.livevox.multiplier.dao.PropertyDao;
import com.livevox.multiplier.domain.AuthResponse;
import com.livevox.multiplier.domain.LvSession;
import com.livevox.multiplier.domain.Response;
import com.livevox.multiplier.domain.exceptions.AtgRuntimeException;
...
public class SignInService extends RestServiceAbstract implements Serializable {
    ...
    public SignInService(@Qualifier("atgConfigService") AtgConfigService configSrvc) {
        if(configSrvc == null) {
