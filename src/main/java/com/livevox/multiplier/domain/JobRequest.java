...
import com.livevox.multiplier.domain.requests.RecordingReportRequest;
...
import com.livevox.multiplier.domain.lvapi.*;
...
public class JobRequest implements Serializable {
    ...
    private static final long serialVersionUID = 986247234413L;
    ...
    public DialingProfile toDialingProfile()  {
        try {
            DialingProfile profile = new DialingProfile();
            BeanUtils.copyProperties(profile, this);
            profile.setApiSessionId(getSessoinId());
            return profile;
        } catch(Exception e) {
            throw new IllegalStateException(e);
        }
    ...
    public CallDetail toCallDetail()  {
        try {
            ...
            BeanUtils.copyProperties(call, this);
            call.setPhoneDialed(phone);
            call.setZipCode(zip);
            if (getCallCenterIds() != null && getCallCenterIds().isEmpty() &&
                    getCallCenterIds().get(0) != null) {
                call.setCallCenterId(getCallCenterIds().get(0).getId());
            }
            call.setStart((getStartDate() != null) ? getStartDate() : null);
            call.setCampaignId((getCampaignId() != null) ? getCampaignId() : null);
            if (getTermCodes() != null && getTermCodes().isEmpty() &&
                    getTermCodes().get(0) != null) {
                call.setLvResultId(getTermCodes().get(0));
            }
    ...
    public List<IdType> getServiceIds() {
    ...
    public List<Long> findServiceIdsAsLong() {
        ...
        for(IdType idType: filter.getService()) {
    ...
    public void setServiceIds(List<IdType> newServiceIds) {
        if(filter == null) {
    ...
    public List<IdType> getCallCenterIds() {
    ...
    public List<Long> findCallCenterIdsAsLong() {
        ...
        for(IdType idType: filter.getCallCenter()) {
            if(idType != null && idType.getId() != null) {
